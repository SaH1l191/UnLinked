...
export default function NotifcationsPage() {
    ...
    const renderRelatedPost = (relatedPost) => {
        ...
        return (
            <Link to={`/post/${relatedPost._id}`} className='flex items-center p-2 mt-2 space-x-2 transition-colors rounded-md bg-gray-50 hover:bg-gray-100'>
                {
                    relatedPost.image && (
                        <img src={relatedPost.image} alt='Post preview' className='object-cover w-10 h-10 rounded' />
                    )
                }
