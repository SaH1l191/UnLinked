...
export default function UserCard({ user, isConnection }) {
	return (
		<div className='flex flex-col items-center p-4 transition-all bg-white rounded-lg shadow hover:shadow-md'>
			...
			<p className='mt-2 text-sm text-gray-500'>{user.connections?.length} connections</p>
			<button className='w-full px-4 py-2 mt-4 text-white transition-colors rounded-md bg-primary hover:bg-primary-dark'>
