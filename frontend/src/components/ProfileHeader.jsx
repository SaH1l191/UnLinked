...
const ProfileHeader = ({ userData, onSave, isOwnProfile }) => {
  ...
  //getting al the related userconnections of that user
  ...
  return (
    <div className='mb-6 bg-white rounded-lg shadow'>
      {/* added the image in the div bg -cover */}
      <div
      ...
      >
        {/* added the camera icon in top right of the image  */}
        {isEditing && (
