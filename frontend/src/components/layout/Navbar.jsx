							...
							<>
								...
								<Link to='/network' className='relative flex flex-col items-center text-neutral'>
									...
									{unreadConnectionRequestsCount > 0 && (
										<span
											className='absolute flex items-center justify-center text-xs text-white bg-blue-500 rounded-full -top-1 -right-1 md:right-4 size-3 md:size-4'
										>
											{unreadConnectionRequestsCount}
										</span>
									)}
								</Link>
								<Link to='/notifications' className='relative flex flex-col items-center text-neutral'>
									<Bell size={20} />
